...
WebUI.waitForElementVisible(findTestObject('3D Point Cloud Location Tab Test object'), 1000)

WebUI.click(findTestObject('3D Point Cloud Location Tab Test object'))
